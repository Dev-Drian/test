/**
 * Integrations - Página para gestionar integraciones externas
 * 
 * Permite conectar servicios como Google Calendar, Sheets, etc.
 */
    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-zinc-400">
          Conecta servicios externos para potenciar tus automatizaciones
        </p>
      </div>
      ...
      <div className="grid gap-6">
        ...
        <div className="p-6 rounded-2xl bg-zinc-900/30 border border-zinc-800/50 opacity-60">
          <div className="flex items-center gap-4">
            ...
            <span className="px-3 py-1 rounded-full text-xs font-medium bg-zinc-800 text-zinc-500">
              Próximamente
            </span>
          </div>
        </div>
      ...
      <div className="mt-8 p-4 rounded-xl bg-blue-500/5 border border-blue-500/20">
        <h4 className="text-sm font-medium text-blue-400 mb-2">💡 ¿Cómo usar las integraciones?</h4>
        <p className="text-sm text-zinc-400">
          ...
          o exportar datos a Google Sheets automáticamente.
        </p>
      </div>
