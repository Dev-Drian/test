...
const navItems = [
  ...
  { to: "/guia", label: "Guía", icon: icons.guide },
];
...
export default function Layout() {
  ...
  return (
    <div className="flex min-h-screen bg-[#09090b]">
      {/* Sidebar */}
      <aside className="w-[260px] bg-[#0c0c0f] border-r border-white/[0.06] flex flex-col">
        ...
        <div className="h-16 px-5 flex items-center gap-3 border-b border-white/[0.06]">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] text-zinc-500 font-medium tracking-wide">AI CRM</span>
          </div>
        </div>
        ...
        <nav className="flex-1 py-3 px-3">
          <div className="space-y-1">
            {navItems.map(({ to, label, icon }) => (
              ...
              >
                <span className={`transition-colors ${isActive(to) ? 'text-emerald-400' : 'text-zinc-500 group-hover:text-zinc-300'}`}>
                  {icon}
                </span>
                <span>{label}</span>
                {isActive(to) && (
        ...
        <div className="p-3 border-t border-white/[0.06]">
          {workspaceId ? (
            <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-emerald-500/[0.08] border border-emerald-500/20">
              ...
              <div className="flex-1 min-w-0">
                <span className="block text-[10px] text-emerald-400/70 font-medium uppercase tracking-wide">
                  Workspace activo
                </span>
            ...
            <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-white/[0.02] border border-white/[0.06]">
              ...
              <span className="text-xs text-zinc-500">Sin workspace</span>
            </div>
          )}
        </div>
      </aside>
