/**
 * ChatConstants - Iconos SVG de canales, definiciones de canales, colores y gradientes.
 */
...
export const AllChannelsIcon = ({ className }) => (
...
export const EXTERNAL_CHANNEL_LABELS = {
  whatsapp: "WhatsApp",
  messenger: "Messenger",
  instagram: "Instagram",
  telegram: "Telegram",
