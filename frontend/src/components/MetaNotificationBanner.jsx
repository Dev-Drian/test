 ...
 *
 * Soporta tipos: meta:message, telegram_message, flow:completed, flow:failed, payment:confirmed, agent:error, system:info
 */
...
const NOTIF_TYPES = {
  ...
  // Telegram
  'telegram_message': { label: 'Telegram', Icon: TelegramIcon, color: '#0088cc', bg: 'rgba(0,136,204,0.15)', border: 'rgba(0,136,204,0.3)', route: '/chat' },
...
const PLATFORM = {
  ...
  telegram:  { label: 'Telegram',  Icon: TelegramIcon,  color: '#0088cc', bg: 'rgba(0,136,204,0.15)', border: 'rgba(0,136,204,0.3)' },
};
