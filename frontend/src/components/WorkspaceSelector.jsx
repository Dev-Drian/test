  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        style={{ border: isOpen ? '1px solid rgba(99, 102, 241, 0.4)' : '1px solid rgba(100, 116, 139, 0.3)' }}
      >
        {selectedWorkspace ? (
          <div
        ...
        <div className="flex-1 text-left min-w-0">
          <span className="block text-slate-100 font-medium truncate text-[13px]">
      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-2 rounded-xl overflow-hidden z-50 animate-fade-up">
          <div className="rounded-xl shadow-lg" style={{ background: '#1e293b', border: '1px solid rgba(100, 116, 139, 0.3)' }}>
            <div className="px-3 py-2.5" style={{ borderBottom: '1px solid rgba(100, 116, 139, 0.3)' }}>
              <span className="text-[11px] uppercase tracking-wider text-slate-400 font-medium">Workspaces</span>
            </div>
                  ...
                  <li key={ws._id}>
                    ...
                    >
                      ...
                      <span className={`flex-1 truncate text-[13px] font-medium ${
                        ws._id === workspaceId ? 'text-indigo-400' : 'text-slate-100'
                      }`}>
                        {ws.name}
                      </span>
                      {ws._id === workspaceId && (
